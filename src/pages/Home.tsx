        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/gallery"
                className="inline-flex items-center px-8 py-4 bg-white text-red-600 font-semibold rounded-xl hover:bg-red-50 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
              ...
              {user ? (
                <Link
                  to="/upload"
                  className="inline-flex items-center px-8 py-4 bg-red-800/50 text-white font-semibold rounded-xl hover:bg-red-800/70 transition-all duration-200 border border-red-400/30"
                >
